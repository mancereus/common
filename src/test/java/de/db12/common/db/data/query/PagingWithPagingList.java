...
public class PagingWithPagingList extends SetupTestCase {
	...
	public void testPaging() throws Exception {
		...
		for (Order order : list) {
			...
			System.out.println("got order:" + order.getId() + " details:"
					+ detailsCount);
		}
	}
